...
# ones.
extensions = ['sphinxcontrib.seqdiag','sphinxcontrib.blockdiag', 'sphinx_copybutton', 'hoverxref.extension', 'sphinx.ext.todo', 'sphinx.ext.intersphinx',]
...
html_context = {
    ...
    "sidebar_external_links": [
        ...
        (
            '<i class="fa fa-github fa-fw"></i> Project Repository',
    ...
    "sidebar_permanent_nav_caption": "Docs Navigation",
...
latex_documents = [
    (master_doc, 'srsRAN.tex', u'srsRAN Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'srsRAN', u'srsRAN Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'srsRAN', u'srsRAN Documentation',
     author, 'srsRAN', 'srsRAN Documentation.',
     'Miscellaneous'),
]
